<template>
  <div>
    <h4
      class="text-h4 text-center my-6"
      v-text="
        SubBy != null ? `Hello, ${this.SubBy}` : 'Generate Your Cover Page'
      "
    ></h4>
    <v-stepper v-model="TabNo" vertical class="rounded-lg">
      <!-- ##### Step 1 ##### -->
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field
                    ...
                    :label="
                      Content == 'assignment' ? 'Date' : 'Date of Performence'
                    "
                    hide-details="auto"
                    dense
                    outlined
